...
$foldershistory[] = $useruploadfolder;
    ...
    $useruploadfolder = "admin/ckeditor/plugins/imageuploader/uploads2";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "admin/ckeditor/plugins/imageuploader/uploads2";
        

    $useruploadfolder = "admin/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "admin/ckeditor/plugins/imageuploader/uploads";
